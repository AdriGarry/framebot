...
/* UI Service */
app.service('UIService', ['$rootScope', '$http', '$mdToast', 'CONSTANTS', 'Tile', function($rootScope, $http, $mdToast, CONSTANTS, Tile) {
		var ctrl = this;
...
app.service('audioService', ['$rootScope', '$http', 'UIService', function($rootScope, $http, UIService) {
		var ctrl = this;
		...
		function upload(data) {
			console.log('upload()... remove or hide pwd !');
			$http({
				headers: {
					'User-Interface': 'UIv5',
					pwd: 'nn', // TODO useless? to remove? 
					'User-position': 'noPos',
