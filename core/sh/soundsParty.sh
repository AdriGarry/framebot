...
if [ $1 = "startParty" ]
then
	sound="/home/pi/odi/media/mp3/party/startParty.mp3"
	volume=600
elif [ $1 = "pasAssezSaoul" ]
then
	sound="/home/pi/odi/media/mp3/party/pasAssezSaoul.mp3"
	volume=600
elif [ $1 = "puisJeExprimer" ]
then
	sound="/home/pi/odi/media/mp3/party/puisJeExprimer.mp3"
	volume=600
elif [ $1 = "discours" ]
then
	#sudo node /home/pi/odi/core/modules/allLedsOn.js
...
then
	sound="/home/pi/odi/media/mp3/party/23h.mp3"
	volume=600
elif [ $1 = "23h30" ]
then
	sound="/home/pi/odi/media/mp3/party/23h30.mp3"
	volume=600
...
then
	...
	sound="/home/pi/odi/media/mp3/sounds/circuitsTransistors.mp3"
fi
